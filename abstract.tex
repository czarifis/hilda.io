...
To address these issues, we propose {\projname}, an interactive notebook engine that employs a declarative language to facilitate communication with database sources, data curation and creation of interactive visualizations that can react to the reader's input. We also propose a propagation algorithm capable of using the reader's input to reflect changes to other parts of the notebook.
