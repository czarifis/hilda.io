...
\noindent {\bf Data conversions.} \eat{\yannis{I think your use of ``data model" is different than the one used in SIGMOD. I think most of the points you mention are about ``data type/structure" and secondarily about ``data model". I fixed.}}
